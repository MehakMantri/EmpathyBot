...
export default function Home() {
  ...
  const [messages, setMessages] = useState([{
    role: "assistant",
    content: `Hello, I am a EmpathyAI willing to help you through difficult times. How may I be of assistance? `
}])
  ...
  return (
    <Box 
      ...
      <Typography variant="h6" className={bubblegumSans.className} color="#137a63"></Typography>
      <Typography variant="h6" className={bubblegumSans.className} color="#137a63"></Typography>
      <Stack
        direction="column"
        width="600px"
